...
// Dark section with 4 key stats: campuses, attendance, languages, founding year.
// Lives just before HomeInvitation at the bottom of the page.
...
export function HomeNumbers() {
  return (
    <section
      ...
      style={{ background: "#1C1A17", padding: "56px 0" }}
    >
      <div
